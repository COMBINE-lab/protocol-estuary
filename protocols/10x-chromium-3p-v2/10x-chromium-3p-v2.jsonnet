...
local workflow = {
	...
	simpleaf_index_ref_type :: 
		utils.splici(null, null, 98) # recommended
	...
	simpleaf_index : utils.simpleaf_index(1, $.simpleaf_index_ref_type, $.simpleaf_index_arguments, $.simpleaf_index_output),
    simpleaf_quant : utils.simpleaf_quant(2, $.simpleaf_quant_map_type, $.simpleaf_quant_cell_filt, $.simpleaf_quant_arguments, $.simpleaf_quant_output),
};
