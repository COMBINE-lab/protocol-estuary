...
local template = {
        ...
        ref_type ::
                ...
                utils.splici("genome.fa", "genes.gtf", 91) # recommended
                ...
                direct_ref_args : {
                        ref_seq : "transcriptome.fa",
                },
                # utils.direct_ref("path/to/transcriptome.fasta")
                existing_index_args : {
                        index_dir : "path/to/existing_index",
                        t2g_map : "path/to/t2g_3col.tsv" | "path/to/t2g.tsv",
                },
        ...
        map_type ::
                utils.map_reads("orig1.fq.gz", "orig2.fq.gz", $.simpleaf_index) # Recommended
