...
// 10x Chromium 3' Feature Barcode Antibody Capture + CRISPR Screen (TotalSeq-B/C)
...
local template = {
	...
	fast_config : {
        ...
        #-----------------------------------------------------------------------#
        # Fast config section 3 . crispr screen modality
        crispr_screen : {
            #-----------------------------------------------------------------------#
	...
	advanced_config : {
        ...
        antibody_capture : {
            ...
            #-----------------------------------------------------------------------#
                ...
                ref_type : {
                    ...
                    direct_ref : {
                        ref_seq : $.workflow.external_commands.antibody_capture_feature_barcode_ref.ref_seq, # e.g., "path/to/transcriptome.fa" # This defines `/workflow/simpleaf_index/--ref-seq`
                        t2g_map : $.workflow.external_commands.antibody_capture_feature_barcode_ref.t2g_map, # e.g., "path/to/existing_index/t2g.tsv" or "t2g_3col.tsv" # This defines `/workflow/simpleaf_quant/--t2g-map`
                    },
        ...
        #-----------------------------------------------------------------------#
        # Advanced config section 3 : crispr screen modality
        crispr_screen : {
            simpleaf_index : {
            ...
            #-----------------------------------------------------------------------#
                ...
                ref_type : {
                    ...
                    # DO NOT change unless you have a 
                    direct_ref : {
                        ref_seq : $.workflow.external_commands.crispr_screen_feature_barcode_ref.ref_seq, # e.g., "path/to/transcriptome.fa" # This defines `/workflow/simpleaf_index/--ref-seq`
                        t2g_map : $.workflow.external_commands.crispr_screen_feature_barcode_ref.t2g_map, # e.g., "path/to/existing_index/t2g.tsv" or "t2g_3col.tsv" # This defines `/workflow/simpleaf_quant/--t2g-map`
                    },
	...
	##########################################
	meta_info : {
        template_name : "10x Chromium 3' Feature Barcode Antibody Capture + CRISPR Screen (TotalSeq-B/C)",
        template_id : "10x-feature-barcode-abtibody+crispr_totalseq-b-c",
	...
	workflow : {
        ...
        external_commands : {
            ...
            [if $.fast_config.antibody_capture.feature_barcode_csv != null then "antibody_capture_feature_barcode_ref"] : utils.feature_barcode_ref(
                8,
                1,
                5,
            ...
            [if $.fast_config.crispr_screen.feature_barcode_csv != null then "crispr_screen_feature_barcode_ref"] : utils.feature_barcode_ref(
                13, 
                $.fast_config.crispr_screen.feature_barcode_csv, 
                1,
                5,
                $.workflow.crispr_screen.simpleaf_index.output
            ),
        }
	},
};
